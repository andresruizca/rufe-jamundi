...
/**
 * Los tipos de archivo que el APK produce.
 *
 * En la web esto vive en `rufe-form/tipos.ts` junto a todo el formato del censo,
 * que aquí no existe. Se declaran los dos que el ciudadano manda y se conserva
 * `DOCUMENTO` porque `escaleraPara` lo distingue.
 */
export type TipoEvidencia = 'DOCUMENTO' | 'DANO' | 'PRE_CEDULA' | 'PRE_DANO';
