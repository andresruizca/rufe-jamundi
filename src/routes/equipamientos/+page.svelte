...
<svelte:head>
	<title>Equipamientos — Tablero Sismo Jamundí</title>
	<meta
		name="description"
		content="Estado de equipamientos públicos y privados de Jamundí tras el sismo del 10 de agosto: alcaldía, hospital, plaza de mercado, cultura, sector religioso, centros de desarrollo y centros comerciales."
	/>
</svelte:head>
...
<div class="wrap">
	...
	<div class="chart-grid">
		<div class="card span-2">
			<div class="card-head">
				<div>
					<h2>
						<ChartBarIcon size={16} weight="bold" aria-hidden="true" /> Equipamientos por categoría
					</h2>
		...
		<div class="card">
			<div class="card-head">
				<div>
					<h2><ShieldWarningIcon size={16} weight="bold" aria-hidden="true" /> Estado</h2>
		...
		<div class="card">
			<div class="card-head">
				<div>
					<h2>
						<WrenchIcon size={16} weight="bold" aria-hidden="true" /> Visita técnica realizada
					</h2>
		...
		<div class="card">
			<div class="card-head">
				<div>
					<h2><FileTextIcon size={16} weight="bold" aria-hidden="true" /> Informe disponible</h2>
		...
		{#if notasCategorias.length > 0}
			<div class="card">
				<div class="card-head">
					<div>
						<h2>
							<NotePencilIcon size={16} weight="bold" aria-hidden="true" /> Categorías con nota, sin conteo
							aún
						</h2>
	...
	<div class="card">
		<div class="card-head">
			<div>
				<h2><TableIcon size={16} weight="bold" aria-hidden="true" /> Detalle por equipamiento</h2>
				<p class="card-note">
