<script lang="ts">
	...
	import TentIcon from 'phosphor-svelte/lib/TentIcon';
...
<svelte:head>
	<title>Instituciones educativas — Tablero Sismo Jamundí</title>
	<meta
		name="description"
		content="Estado de infraestructura, evacuación y prioridad de atención de las sedes educativas de Jamundí tras el sismo del 10 de agosto."
	/>
</svelte:head>
...
<div class="wrap">
	...
	<div class="chart-grid">
		<div class="card">
			<div class="card-head">
				<div>
					<h2><MapPinIcon size={16} weight="bold" aria-hidden="true" /> Zona rural / urbana</h2>
		...
		<div class="card">
			<div class="card-head">
				<div>
					<h2>
						<ShieldWarningIcon size={16} weight="bold" aria-hidden="true" /> Estado físico de la infraestructura
					</h2>
		...
		<div class="card">
			<div class="card-head">
				<div>
					<h2><DoorOpenIcon size={16} weight="bold" aria-hidden="true" /> Requiere evacuación</h2>
		...
		<div class="card">
			<div class="card-head">
				<div>
					<h2><WrenchIcon size={16} weight="bold" aria-hidden="true" /> Requiere visita técnica</h2>
		...
		<div class="card">
			<div class="card-head">
				<div>
					<h2><BarricadeIcon size={16} weight="bold" aria-hidden="true" /> Vías de acceso</h2>
			...
			<div class="bars">
				...
				{#if agg.viasDeAcceso['Sin dato']}
					<BarRow
						label="Sin dato"
						value={agg.viasDeAcceso['Sin dato']}
						max={maxVias}
						color=""
						dim
					/>
		...
		<div class="card">
			<div class="card-head">
				<div>
					<h2>
						<CalendarXIcon size={16} weight="bold" aria-hidden="true" /> ¿Se suspendieron clases?
					</h2>
		...
		<div class="card">
			<div class="card-head">
				<div>
					<h2>
						<FileTextIcon size={16} weight="bold" aria-hidden="true" /> Concepto técnico disponible
					</h2>
		...
		<div class="card">
			<div class="card-head">
				<div>
					<h2><FlagIcon size={16} weight="bold" aria-hidden="true" /> Prioridad de atención</h2>
		...
		<div class="card">
			<div class="card-head">
				<div>
					<h2><TentIcon size={16} weight="bold" aria-hidden="true" /> Usada como albergue</h2>
			...
			<div class="bars">
				...
				<BarRow
					label="No"
					value={agg.usadaComoAlbergue['No'] ?? 0}
					max={maxAlbergue}
					color=""
					dim
				/>
		...
		<div class="card span-2">
			<div class="card-head">
				<div>
					<h2>
						<ChartBarIcon size={16} weight="bold" aria-hidden="true" /> Sedes con mayor matrícula
					</h2>
		...
		<div class="card span-2">
			<div class="card-head">
				<div>
					<h2><WarningIcon size={16} weight="bold" aria-hidden="true" /> Daños y observaciones</h2>
					<p class="card-note">
	...
	<div class="card">
		<div class="card-head">
			<div>
				<h2><TableIcon size={16} weight="bold" aria-hidden="true" /> Detalle por sede</h2>
				<p class="card-note">
